...
class ConnectToolBar extends Component {
        ...
        <div className="primary-toolbar">
          { renderLogoSection() }
          {
            <div className="search-widget">
              <div className="title">
                Connect - Project Information Edit
              </div>  
            </div>
          }
          <div className="actions">
            {isLoggedIn && <NewGroupNavLink link={'/connect/new'} label={'+ New Project'} />}
            { userMenu }
...
export default withRouter(connect(mapStateToProps, actionsToBind)(ConnectToolBar))
