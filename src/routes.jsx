...
import BulkUploadToolBar from './components/TopBar/BulkUploadToolBar'

import { HelpToolBar, NewGroupToolBar, NewBatchToolBar, NewConnectToolBar, NewBulkUploadToolBar } from './components/TopBar/GeneralToolBar'
...
import BulkUploadList from './bulkUpload/BulkUploadList'
...
import NewBulkUploadContainer  from './bulkUpload/NewBulkUploadContainer'
...
const topBarWithBulkUploadToolBar = <TopBarContainer toolbar={BulkUploadToolBar} />
...
const newBulkUploadToolbar = <TopBarContainer toolbar={NewBulkUploadToolBar} />
    ...
    if (user) {
      return (
        <Switch>
          ...
          <Route path="/bulkUpload/new" render={renderApp(newBulkUploadToolbar, <NewBulkUploadContainer />)} />
          <Route path="/bulkUpload" render={renderApp(topBarWithBulkUploadToolBar, <BulkUploadList />)} />
